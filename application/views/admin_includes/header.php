...
<script type="text/javascript" src="<?php echo base_url(); ?>bootstrap/js/admin.js" ></script>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>bootstrap/css/admin-style.css" />
