<head>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>bootstrap/js/validatr.js" ></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>bootstrap/js/bootstrap.js" ></script>
    
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>bootstrap/css/validatr.css" /> 
